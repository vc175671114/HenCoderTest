...
public class ScalableImageView_new extends View {
    ...
    public ScalableImageView_new(Context context) {
        super(context);
        init(context);
    }

    public ScalableImageView_new(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
